...
ggplot(data = MP_algae, aes(Date, Phyco)) + 
  ...
  geom_hline(yintercept = 10, aes(col = 'black'))

```

```{r}
boxplot(MP ~ site_dp , data = MP_algae, xlab = "Site by Depth", ylab = "Microplastics (#/L)")
```
